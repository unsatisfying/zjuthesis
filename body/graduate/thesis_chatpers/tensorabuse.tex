...
文件泄漏          &\ding{182}(\ding{186\ding{185}})\ding{184}\ding{185}&$\Circle$    &$\Circle$  &$\Circle$            \\ 
\rowcolor[HTML]{EFEFEF}
IP地址暴露         &\ding{185}&$\Circle$    &$\Circle$  &$\Circle$            \\ 

代码执行   &(\ding{184})\ding{183}&$\Circle$    &$\Circle$  &$\Circle$            \\
\rowcolor[HTML]{EFEFEF} 
Shell获取        &\ding{184}\ding{183}(\ding{186})\ding{185}&$\Circle$    &$\Circle$  &$\Circle$                      \\ \hline
\end{tabular}
\vspace{+10pt}
\end{table}
