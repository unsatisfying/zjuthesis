...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.9\linewidth]{figure/一个实现窃取本地文件的恶意 AI 模型例子.png}
    \caption{\label{fig:model_file_leak_example}一个实现窃取本地文件的恶意 AI 模型例子}
\end{figure}
% \begin{figure}[t]
%     \centering
% \begin{lstlisting}[%
...
\begin{itemize}
    \item \textbf{文件系统访问}：文件读，文件写，目录读，目录写。
    \item \textbf{网络访问}：网络发送，网络接收。
    \item \textbf{进程管理}：进程创建，进程撤销，进程睡眠。
    \item \textbf{纯计算}：数学计算，内部数据管理，编码和解码。
    \item \textbf{代码执行}：用户可控函数执行。
\end{itemize}
...
\multicolumn{1}{c|}{\multirow{-2}{*}{\cellcolor[HTML]{C0C0C0}\textbf{实际攻击}}} &
  ...
  \textbf{\ding{174}} \\\hline
                                                                                          ...
                                                                                          & \cellcolor[HTML]{EFEFEF}raw\_ops.LookupTableExport(V2)                                             & \cellcolor[HTML]{EFEFEF}从文件中读取键值对 & \cellcolor[HTML]{EFEFEF}$\Circle$    & \cellcolor[HTML]{EFEFEF}$\Circle$      & \cellcolor[HTML]{EFEFEF}$\Circle$ \\
                                                                                          & \cellcolor[HTML]{FFFFFF}raw\_ops.FixedLengthRecordDataset(V2)                         & \cellcolor[HTML]{FFFFFF}以固定长度读取文件   & $\Circle$     & $\Circle$     &$\Circle$                \\
                                                                                          & \cellcolor[HTML]{EFEFEF}raw\_ops.CSVDataset(V2)                                       & \cellcolor[HTML]{EFEFEF}读取csv文件     & \cellcolor[HTML]{EFEFEF}$\Circle$     & \cellcolor[HTML]{EFEFEF}$\Circle$     & \cellcolor[HTML]{EFEFEF}$\Circle$                     \\
                                                                                          & \cellcolor[HTML]{FFFFFF}raw\_ops.ExperimentalCSVDataset                               & \cellcolor[HTML]{FFFFFF}读取csv文件     & $\Circle$     & $\Circle$     & $\Circle$                     \\
                                                                                          & \cellcolor[HTML]{EFEFEF}raw\_ops.ImmutableConst                                       & \cellcolor[HTML]{EFEFEF}读取文件的ASCII码    & \cellcolor[HTML]{EFEFEF}$\Circle$     & \cellcolor[HTML]{EFEFEF}$\Circle$     & \cellcolor[HTML]{EFEFEF}$\Circle$      \\
\multirow{-7}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}任意\\ 文件读\end{tabular}}}  & \cellcolor[HTML]{FFFFFF}raw\_ops.InitializeTableFromTextFile(V2)                      & \cellcolor[HTML]{FFFFFF}读取键值对类型文件         & $\Circle$    & $\Circle$     & $\Circle$               \\ \hline
                                                                                          & \cellcolor[HTML]{EFEFEF}raw\_ops.WriteFile                                            & \cellcolor[HTML]{EFEFEF}创建并向文件中覆盖写   & \cellcolor[HTML]{EFEFEF}$\CIRCLE$  & \cellcolor[HTML]{EFEFEF}$\Circle$ &\cellcolor[HTML]{EFEFEF}$\Circle$   \\
                                                                                          ...
                                                                                          & \cellcolor[HTML]{EFEFEF}raw\_ops.Save(V2)                                             & \cellcolor[HTML]{EFEFEF}创建并向文件中写数据集  & \cellcolor[HTML]{EFEFEF}$\Circle$     & \cellcolor[HTML]{EFEFEF}$\Circle$     & \cellcolor[HTML]{EFEFEF}$\Circle$   \\
\multirow{-4}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}任意\\ 文件写\end{tabular}}} & \cellcolor[HTML]{FFFFFF}raw\_ops.PrintV2                                              & \cellcolor[HTML]{FFFFFF}向文件末尾添加内容     & \cellcolor[HTML]{FFFFFF}$\Circle$     & \cellcolor[HTML]{FFFFFF}$\Circle$     & \cellcolor[HTML]{FFFFFF}$\Circle$       \\ \hline
                                                                                          & \cellcolor[HTML]{EFEFEF}raw\_ops.MatchingFiles                                        & \cellcolor[HTML]{EFEFEF}获取特定格式的文件路径 & \cellcolor[HTML]{EFEFEF}$\Circle$  & \cellcolor[HTML]{EFEFEF}$\Circle$                   & \cellcolor[HTML]{EFEFEF}$\Circle$ \\
...
\multirow{-3}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}目录\\ 读取\end{tabular}}}       & \cellcolor[HTML]{EFEFEF}raw\_ops.MatchingFilesDataset                                 & \cellcolor[HTML]{EFEFEF}获取特定格式的文件路径  & \cellcolor[HTML]{EFEFEF}$\Circle$  & \cellcolor[HTML]{EFEFEF}$\Circle$                   & \cellcolor[HTML]{EFEFEF}$\Circle$\\ \hline
                                                                                          ...
                                                                                          & \cellcolor[HTML]{EFEFEF}raw\_ops.DistributedSave                                      & \cellcolor[HTML]{EFEFEF}向任意IP地址发送数据集             & \cellcolor[HTML]{EFEFEF}$\Circle$  & \cellcolor[HTML]{EFEFEF}$\Circle$                   & \cellcolor[HTML]{EFEFEF}$\Circle$  \\
                                                                                          ...
                                                                                          & \cellcolor[HTML]{EFEFEF}rpc.kernels.gen\_rpc\_ops.rpc\_call   & \cellcolor[HTML]{EFEFEF}向任意IP地址发送字符串     & \cellcolor[HTML]{EFEFEF}$\RIGHTcircle$   & \cellcolor[HTML]{EFEFEF}$\Circle$  & \cellcolor[HTML]{EFEFEF}$\Circle$        \\
...
\textbf{\begin{tabular}[c]{@{}c@{}}网络\\ 接收\end{tabular}}                        & \cellcolor[HTML]{EFEFEF}rpc.kernels.gen\_rpc\_ops.rpc\_client & \cellcolor[HTML]{EFEFEF}从远端服务器接收消息      & \cellcolor[HTML]{EFEFEF}$\RIGHTcircle$    & \cellcolor[HTML]{EFEFEF}$\Circle$                   & \cellcolor[HTML]{EFEFEF}$\Circle$             \\ \hline
\end{tabular}
\begin{tablenotes}
\small
    \item[*] \ding{172}：ModelScan 检测，\ding{173}：Huggingface 检测，\ding{174}：TensorFlow Hub 检测。
    \item[*] $\Circle$：可以绕过检测，$\RIGHTcircle$：导致中度警告，$\Circle$：导致高度警告。
\end{tablenotes}
\end{threeparttable}
\end{table}
\subsection{攻击原语构建}
...
\textbf{攻击1：文件泄漏。}
如图~\ref{fig:model_file_leak_example}展示了利用任意目录读取，文件读取和网络发送三个原语组合构造文件泄漏攻击，具体来说，可以首先使用任意目录读取原语，获取受害者系统内的文件路径信息，然后利用该信息组合构造敏感文件的绝对路径，接着使用文件读取原语来加载敏感文件内容到内存中（这一步也可以使用网络发送和网路接收原语向受害者发送敏感文件路径，而不是直接在受害者本地构造），例如 \code{/etc/passwd} 文件或者 ssh 密钥文件，最后通过网络发送原语讲读入内存的文件内容泄露给恶意服务器。
...
\caption{实际 TensorAbuse 攻击检测绕过表}
...
文件泄漏          &\ding{182}(\ding{186\ding{185}})\ding{184}\ding{185}&\checkmark     &\checkmark   &\checkmark             \\ 
\rowcolor[HTML]{EFEFEF}
IP地址暴露         &\ding{185}&\checkmark     &\checkmark   &\checkmark             \\ 

代码执行   &(\ding{184})\ding{183}&\checkmark     &\checkmark   &\checkmark             \\
\rowcolor[HTML]{EFEFEF} 
Shell获取        &\ding{184}\ding{183}(\ding{186})\ding{185}&\checkmark     &\checkmark   &\checkmark                       \\ \hline
\end{tabular}
\vspace{+10pt}
\end{table}
