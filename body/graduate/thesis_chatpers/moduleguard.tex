...
\begin{tabular}{lcc}
\hline
\multicolumn{1}{c}{\cellcolor[HTML]{C0C0C0}\textbf{模块路径}}      & \cellcolor[HTML]{C0C0C0}\textbf{最新版本包}数量  & \cellcolor[HTML]{C0C0C0}\textbf{所有版本包数量}\\ \hline
...
\toprule
\cellcolor[HTML]{C0C0C0}\textbf{开源项目} & \cellcolor[HTML]{C0C0C0}\textbf{工单号} & \cellcolor[HTML]{C0C0C0}\textbf{已回复} & \cellcolor[HTML]{C0C0C0}\textbf{已修复} \\ \midrule
...
qpzzk/zz\_spider & \#1 & - & - \\
\cellcolor[HTML]{EFEFEF}NickHugi/PyKotor & \cellcolor[HTML]{EFEFEF}\#3 & \cellcolor[HTML]{EFEFEF}$\checkmark$ & \cellcolor[HTML]{EFEFEF}$\checkmark$ \\ \bottomrule
\end{tabular}
\end{table}
